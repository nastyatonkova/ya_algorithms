"""
The IT conference was attended by students from different universities 
from all over the country. 
For each student, the ID of the university where he or she studies is known.

Timofey suggested that Rita find out from which k universities the most students came to the conference. 
"""
